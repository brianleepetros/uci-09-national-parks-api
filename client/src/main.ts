...
const eventsContainer = document.getElementById("events-body") as HTMLDivElement;
...
const renderHistory = async (history: State[]) => {
    try {
        if (searchHistoryContainer) {
            ...
            if (!history.length) {
                searchHistoryContainer.innerHTML = '<p class="col-12 text-center">No Previous Search History</p>';
            }
